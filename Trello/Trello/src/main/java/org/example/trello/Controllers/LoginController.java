...
public class LoginController {
    ...
    public ResponseEntity<String> login(@RequestBody Map<String, String> credentials) {
        ...
        System.out.println("Attempting login for: " + credentials.get("password"));// Логируем логин
        try {
            // Для отладки:
            ...
            System.out.println("Input password: " + credentials.get("password"));
            ...
            System.out.println("Authentication successful for: " + authentication.getName()); // Логируем успех
            SecurityContextHolder.getContext().setAuthentication(authentication);
            return ResponseEntity.ok("Welcome, " + authentication.getName() + "!");
        } catch (Exception e) {
            System.out.println("Authentication failed: " + e.getMessage()); // Логируем ошибку
